...
function generateArr()
{
  ...
  for(let i= 0; i<num; i++)
  {
    ...
    // bar.style.cssText =`${val*3}px; translateX(${i*30}px)`;
...
function dis()
{
  document.getElementById("generate-arr").disabled = "true";
  document.getElementById("generate-arr").style.backgroundColor = "rgb(214, 209, 209);"
  document.getElementById("selection-sort").disabled = "true";
  document.getElementById("selection-sort").style.backgroundColor = "rgb(214, 209, 209);"
  document.getElementById("insertion-sort").disabled = "true";
  document.getElementById("insertion-sort").style.backgroundColor = "rgb(214, 209, 209);"
  document.getElementById("bubble-sort").disabled = "true";
  document.getElementById("bubble-sort").style.backgroundColor = "rgb(214, 209, 209);"
}